...
import java.security.{InvalidKeyException, PrivateKey, PublicKey, SignatureException, Signature as JSignature}
...
object SignatureVerifier:
	...
	def jsigVerifier(pubKey: PublicKey, sig: JSignature): MessageSignature.SignatureVerifier[IO, Unit] =
		(signingStr, signature) => IO {
