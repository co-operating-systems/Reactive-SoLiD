...
/** Sadly Akka's MediaType registry is not extensible, and the file extension names are often oddly
  * chosen Todo: extend this so that servers can configure the extensions
  */
object FileExtensions:
   val akkaMimeTypes = Seq(
   ...
   for m <- akkaMimeTypes ++ RDFMediaTypes.all do registerFileExtensions(m)
